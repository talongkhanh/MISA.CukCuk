      ...
      <div class="dialog-body">
        ...
        <div class="group-general-info">
          <div class="group-left">
            <div class="row">
              <label
                >Mã nhân viên <span class="label-required">(*)</span></label
              >
              <input
                ref="employeeCode"
                id="txtEmployeeCode"
            ...
            <div class="row">
              <label title="Số điện thoại di động"
                >Số điện thoại <span class="label-required">(*)</span></label
              >
              <input
            ...
            <div class="row">
              <div class="flex-container">
                <label title="Số chứng minh thư nhân dân hoặc sổ hộ chiếu"
                  >Số CMT/HC<span class="label-required">(*)</span></label
                >
                <input
                  @keydown="onlyNumber($event)"
          ...
          <div class="group-right">
            <div class="avatar-box">
              ...
              <button class="ct-btn ct-btn-avatar btn-remove-avatar" disabled>
                <span style="width: 16px; height: 16px;">x</span>
              </button>
            </div>
